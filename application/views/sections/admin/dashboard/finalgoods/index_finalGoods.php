                        ...
                        <tbody>
                            <?php foreach ($finalGoods as $finalGood) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>FinalGoods/editFinalGoods/<?php echo $finalGood['id']; ?>" class='btn btn-primary' type='submit'>Update</a>
                                        <a href="<?php echo base_url(); ?>FinalGoods/deleteFinalGoods/<?php echo $finalGood['id']; ?>" class='btn btn-danger' type='submit'>Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
